...
/**
 添加一个view到UIStackView中，如果StackView已有标签相同的view，将无法加入
...
/**
 在UIStackView删除一个标签为‘name’的view
 @param name 需要删除的目标view的标签
 */
- (void)removeViewForName:(NSString*)name;

/**
 删除UIStackView中的所有View
 */
- (void)removeViewAll;

/**
 在UIStackView中的固定位置插入一个view
